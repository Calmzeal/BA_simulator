...
class StrategyFixedPeerLatency:
    def __init__(self, debug_allow_borrow, withhold, extra_send, one_way_latency):  # Checked
        # Config fields
    ...
    def adversary_mined(self, side, block):  # Checked
        if side == "L":
    ...
    def maintain_recent_blocks(self, timestamp, recent_latency):  # Checked
